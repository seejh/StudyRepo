...
DB 같은 느린 데이터 소스에 반복적으로 액세스하는 대신, 자주 사용하는 데이터를 메모리에 저장하여 앱의 성능을 향상시키는 일반적인 캐싱의 내용으로 <br/> 
인 메모리(ASP.NET Core 웹 내 메모리) 방법과 분산 (ASP.NET과 별개의 프로그램 또는 머신의 메모리) 방법의 차이점 분석 <br/>
